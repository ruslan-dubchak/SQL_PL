...
select * from integ.film f where film_id = 100;

select * from dds.film f where film_id = 100;*/


--update integ.inventory  
--set 
--   film_id  = 100
--where 
--	inventory_id = 5;
--
--select * from dds.inventory i where inventory_id = 5;
-------------------------------------------------------------------------------------------------------------------------------------------------
call  full_load();


select * from ods.payment p where payment_id = 32098