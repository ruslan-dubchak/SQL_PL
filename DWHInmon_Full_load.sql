...
as $$
	...
	begin
		...
		-- индикаторы всех созданных , измененных или удаленных строк с предыдущей загрузки из ods в integ
...
--- вствляем  из integ все соданные , изминенные или удаленные платежи с предыдущей загрузки из ОДС в ИНТ
		...
		join  updated_integ_pay_id_list upp
			on upp.payment_id  = rp.payment_sk  
		join ref.staff rs 
...
select * from ods.payment p order by last_update desc;
select * from "ref".payment p where payment_nk = 32098;
